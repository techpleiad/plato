...
public class HtmlService implements IHtmlServiceUseCase {
    ...
    public Map<String, Map<String, BranchProfileReport>> convertBranchReportToHashMap(final List<ConsistencyAcrossBranchesReport> reportList) {
    ...
    public String createBranchTable(final Map<String, Map<String, BranchProfileReport>> branchReport) {
    ...
    public String createBranchTableRow(final Map.Entry<String, Map<String, BranchProfileReport>> serviceName, final Set<String> profileNames) {
    ...
    public String createBranchTableColumn(final Map<String, BranchProfileReport> profileReport, final String profile) {
    ...
    public Map<String, Map<String, List<String>>> convertProfileReportToHashMap(final List<ConsistencyAcrossProfilesReport> reportList) {
    ...
    public String createProfileTable(final Map<String, Map<String, List<String>>> profileReport) {
        final Set<String> profileNames = new HashSet<>();
    ...
    public String createProfileTableRow(final Map.Entry<String, Map<String, List<String>>> serviceName, final Set<String> profileNames) {
        final StringBuilder columns = new StringBuilder("<td style=\"border: 1px solid black; border-collapse: collapse; padding: 15px; text-align: left;\">" + serviceName
                .getKey() + "</td>");
        for (final String profile : profileNames) {
    ...
    public String createProfileTableColumn(final Map<String, List<String>> profileReport, final String profile) {
        if (profileReport.containsKey(profile)) {
    ...
    public String createMissingPropertiesText(final List<ConsistencyAcrossProfilesReport> reportList) {
